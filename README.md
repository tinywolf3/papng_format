...
- **선택적 메타데이터:** 출력 크기, 바운딩 박스, 픽셀 배수, 피벗, 애니메이션 구간, 마스크 그룹과 프레임별 소켓 위치·회전을 저장합니다.
