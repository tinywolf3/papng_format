...
Unreal Engine **5.8.2** 기반 독립 실행형 이미지 뷰어, 앱 버전 **0.1.0**입니다. Godot 뷰어의 재생·마스크·위치 표시·배경·소켓 결합 기능을 Slate 화면으로 제공합니다. 포맷은 PAPNG 1.1을 그대로 사용합니다.
...
Slate 파일 브라우저와 엔진 색상 선택 대화상자를 사용합니다. 파일을 창에 끌어 놓아 열 수도 있습니다. 배경은 엔진 ImageWrapper에서 지원하는 PNG·JPEG·BMP 등의 이미지를 사용합니다. 마스크의 ΔH·ΔS·ΔV를 조절하며 픽셀별 알파는 원본값을 유지합니다.
